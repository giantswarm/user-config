...
var (
	...
	InvalidSignalReadyError         = errgo.New("invalid signal ready value")
...
func IsInvalidSignalReady(err error) bool {
	return errgo.Cause(err) == InvalidSignalReadyError
}
